...
namespace miniproject
{
    ...
    {
        public SqlConnection sqlConnection = new SqlConnection(@"Data Source=DESKTOP-07IKVCJ\SQLEXPRESS;Initial Catalog=santosh;Integrated Security=True");
        public Form3()
        {
            InitializeComponent();
        }
                ...
                else
                {
                    ...
                    else if (checkBox1.Checked)
                    {
                        for (y = x; y <= 2013; y++)
                        {
                            ...
                            sqlConnection.Open();
                            sqlComman.CommandText = "SELECT amount FROM master where year= '" + l + "' and [Given Name] = '" + textBox1.Text + "' and category='2' ";
                    ...
                    else if (checkBox2.Checked)
                    {
                        for (y = x; y <= 2013; y++)
                        {
                            ...
                            sqlComman.Connection = sqlConnection;
                            sqlConnection.Open();
                            sqlComman.CommandText = "SELECT amount FROM master where year= '" + l + "' and [Given Name] = '" + textBox1.Text + "' and category='1' ";
